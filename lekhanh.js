...
const login = require("./lekhanh/fca-sex"); 
...
const { Sequelize, sequelize } = require("./lekhanh/database");
writeFileSync(global.client.configPath + ".temp", JSON.stringify(global.config, null, 4), 'utf8');
/////////////////////////////////////////
//========= Load language use =========//
/////////////////////////////////////////
const langFile = (readFileSync(`${__dirname}/lekhanh/languages/${global.config.language || "en"}.lang`, { encoding: 'utf-8' })).split(/\r?\n|\r/);
...
function onBot({ models: botModel }) {
    ...
    login(loginData, async(loginError, loginApiData) => {
        ...
        const listener = require('./lekhanh/listen')(listenerData);
    ...
    try {
        try {
            ...
            const sequelize2 = new Sequelize({
                dialect: "sqlite",
                host: __dirname + '/lekhanh/datasqlite/antists.sqlite',
                logging: false
            });
        ...
        authentication.sequelize = sequelize;
        const models = require('./lekhanh/database/model')(authentication);
        const botData = {};
